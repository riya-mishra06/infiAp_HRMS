    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex items-center justify-between px-2 pb-6 border-b border-slate-100">
         ...
         <div className="flex items-center gap-4">
            <button className="flex items-center gap-3 px-8 py-4 bg-slate-900 text-white font-black text-[10px] uppercase tracking-widest rounded-2xl hover:bg-slate-800 transition-all shadow-2xl shadow-slate-100 active:scale-95 group">
         ...
         <div className="xl:col-span-5 2xl:col-span-4 space-y-10">
            ...
            <div className="bg-white rounded-[56px] border border-slate-50 shadow-soft p-12 relative overflow-hidden group">
               <div className="relative z-10">
                  ...
                  <div className="bg-linear-to-br from-indigo-600 to-indigo-700 rounded-[44px] p-10 text-white shadow-3xl shadow-indigo-100 relative overflow-hidden group/gross">
                     <p className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-100 mb-2">Current Monthly Gross</p>
                     ...
                     <div className="flex items-center gap-3 px-5 py-2.5 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 w-fit">
                        <Calendar size={12} />
                        <span className="text-[9px] font-black uppercase tracking-widest text-indigo-50">Effective from Jan 2024</span>
                     </div>
                     {/* Decorative Elements */}
            ...
            <div className="bg-slate-900 rounded-[56px] p-12 text-white shadow-soft relative overflow-hidden border-b-8 border-b-indigo-500">
               <div className="flex justify-between items-start mb-10 relative z-10">
                  <div>
                     <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 mb-1">Annual CTC</p>
               ...
               <div className="space-y-6 relative z-10">
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 border-b border-white/5 pb-4">Year-over-Year Comparison <span className="text-slate-700 ml-4 font-normal">2023 VS 2024</span></p>
                  
                  <div className="grid grid-cols-2 gap-6">
                     <div className="p-6 bg-white/5 rounded-[28px] border border-white/5">
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Monthly Gross</p>
                     ...
                     <div className="p-6 bg-white/5 rounded-[28px] border border-white/5">
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Annual CTC</p>
                        <div className="flex items-center gap-2">
         ...
         <div className="xl:col-span-7 2xl:col-span-8 space-y-12">
               ...
               <div className="p-10 border-b border-slate-50 flex items-center justify-between">
                  <div className="flex items-center gap-6">
                     ...
                     <div>
                        ...
                        <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Calculated Monthly Protocol</p>
                     </div>
                  </div>
                  <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Monthly</span>
               </div>
               ...
               <div className="p-10 space-y-6">
                  {earnings.map((item, idx) => (
                    <div key={idx} className="flex items-center justify-between group cursor-pointer hover:translate-x-1 transition-transform">
                       <p className="text-xs font-black text-slate-500 uppercase tracking-widest group-hover:text-slate-800 transition-colors">{item.label}</p>
                       <p className="text-lg font-black text-slate-800 tracking-tight">{item.amount}</p>
                    </div>
                  ))}
                  <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                     <p className="text-sm font-black text-slate-800 uppercase tracking-widest">Total Earnings</p>
            ...
            <section className="bg-white rounded-[64px] border border-slate-50 shadow-soft overflow-hidden">
               <div className="p-10 border-b border-slate-50 flex items-center justify-between">
                  <div className="flex items-center gap-6">
                     ...
                     <div>
                        ...
                        <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Compliance & Security Retention</p>
                     </div>
                  </div>
                  <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Monthly</span>
               </div>
               ...
               <div className="p-10 space-y-6">
                  ...
                  <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                     <p className="text-sm font-black text-slate-800 uppercase tracking-widest">Total Deductions</p>
            ...
            <div className="p-12 bg-linear-to-r from-slate-900 to-slate-800 rounded-[56px] text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
               <div className="relative z-10 flex items-center gap-8">
                  ...
                  <div>
                     <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-500 mb-1">Estimated Monthly Net Pay</p>
               ...
               <div className="relative z-10 text-right">
                  ...
                  <button className="px-10 py-5 bg-indigo-600 text-white text-[11px] font-black uppercase tracking-[0.3em] rounded-[24px] hover:bg-indigo-700 active:scale-95 transition-all shadow-2xl shadow-indigo-900/50">
                     Approve Protocol
                  </button>
               </div>
               {/* Pattern Detail */}
