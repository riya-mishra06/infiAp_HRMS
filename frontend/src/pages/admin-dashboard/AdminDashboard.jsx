  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700 pb-40">
       ...
       <div className="flex items-center justify-between border-b border-slate-50 pb-8">
          <div>
             <h1 className="text-2xl font-black text-slate-800 tracking-tight uppercase">Company Administration</h1>
             <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Master Node Control & Institutional Auditing</p>
          </div>
       ...
       <div className="bg-slate-900 p-10 rounded-3xl text-white shadow-xl relative overflow-hidden group">
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
             <div className="max-w-xl">
                ...
                <h2 className="text-xl font-black tracking-tight mb-2 uppercase">Core status: Optimal Environment</h2>
                <p className="text-slate-500 font-bold text-xs leading-relaxed max-w-sm uppercase tracking-widest">100% of infrastructure services are operational and secured across all managed business units.</p>
             </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreModules.map((module, i) => (
            ...
            >
               ...
               <h3 className="text-sm font-black text-slate-800 tracking-tight uppercase mb-1.5 group-hover:text-indigo-600 transition-colors">{module.name}</h3>
               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-relaxed mb-8">{module.desc}</p>
               <div className="mt-auto flex items-center justify-between w-full">
                  <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest bg-slate-50 px-2 py-1 rounded-md">{module.tag}</span>
                  <div className="w-8 h-8 bg-slate-50 rounded-full flex items-center justify-center text-slate-200 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                     <ArrowRight size={14} />
                  </div>
               </div>
            </div>
